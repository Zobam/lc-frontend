...
const galleryImages = [
    { src: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=300&h=220&fit=crop', alt: 'Worship' },
    { src: 'https://images.unsplash.com/photo-1438032005730-c779502df39b?w=300&h=220&fit=crop', alt: 'Community' },
    { src: 'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=300&h=220&fit=crop', alt: 'Sermon' },
    { src: 'https://images.unsplash.com/photo-1494522855154-9297ac14b55f?w=300&h=220&fit=crop', alt: 'Prayer' },
    { src: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=300&h=220&fit=crop', alt: 'Youth' },
    { src: 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=300&h=220&fit=crop', alt: 'Women' },
];
</script>
